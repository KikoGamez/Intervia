...
function GestoriaIllustration() {
  return (
    <svg viewBox="0 0 480 440" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full max-w-md">
      ...
      <text x="242" y="53" fill="#6b7280" fontSize="5.5">Declaracion censal de alta, modificacion y baja</text>
      {/* Model number box */}
      ...
      <text x="434" y="53" textAnchor="middle" fill="#6b7280" fontSize="5">Pag. 1</text>
      ...
      {/* Denominacion social row - FILLING */}
      <text x="200" y="124" fill="#6b7280" fontSize="5.5">Apellidos y nombre o razon social</text>
      ...
      <text x="214" y="164" fill="#4b5563" fontSize="6.5" fontWeight="600">ACTIVIDAD ECONOMICA</text>

      {/* IAE row - empty, placeholder */}
      <text x="200" y="181" fill="#6b7280" fontSize="5.5">Epigrafe I.A.E.</text>
      <g>
        {[0,1,2,3].map((i) => (
      ...
      <text x="222" y="298" fill="#374151" fontSize="5.5">IVA -- Regimen general</text>

      <rect x="206" y="305" width="10" height="10" rx="1.5" fill="white" stroke="#d1d5db" strokeWidth="0.6" />
      <text x="222" y="313" fill="#6b7280" fontSize="5.5">IRPF -- Estimacion directa</text>
      ...
      <text x="325" y="352" textAnchor="middle" fill="#9ca3af" fontSize="5">Modelo 036 -- Agencia Estatal de Administracion Tributaria</text>
